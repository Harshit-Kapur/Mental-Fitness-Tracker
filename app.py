...
filepath = "C:/Users/Harshit Dinesh Kapur/Mental-Fitness-Tracker/model.pkl"
if os.path.exists(filepath):
    file = open(r"C:\Users\Harshit Dinesh Kapur\Mental-Fitness-Tracker\model.pkl", 'rb')
...
if button_clicked:
    ...
    predict= codedata.predict(df.values)
